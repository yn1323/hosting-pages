import{j as o,a as w}from"./iframe-COcqzGrj.js";import{C as p,u as B}from"./index-B0918Vfx.js";import{V as T}from"./v-stack-B7LUPPxa.js";import"./preload-helper-Dp1pzeXC.js";import"./zod-DpOEOZEV.js";import"./index-CIpWWx6B.js";import"./factory-CuBdPgDb.js";import"./responsive-modal-BHXaZqQZ.js";import"./index-C0M_sRHr.js";import"./create-slot-recipe-context-Bnqxr7JM.js";import"./render-strategy-CRtEXsNa.js";import"./use-breakpoint-w5wazOwz.js";import"./index-Bf8M5Nh4.js";import"./index-znfn4JnW.js";var r,s,i;const{expect:l,screen:m,userEvent:v,within:x}=__STORYBOOK_MODULE_TEST__,S={title:"features/top/CreateRoomModal",component:p,parameters:{layout:"centered"}},f=()=>{const{openModal:a,modalProps:c}=B(),n=async t=>{console.log("ルーム作成:",t),alert(`ルーム "${t}" を作成しました！`)};return o.jsxs(T,{gap:4,children:[o.jsx(w,{onClick:a,colorPalette:"blue",size:"lg",children:"ルーム作成モーダルを開く"}),o.jsx(p,{...c,onCreateRoom:n})]})},e={render:()=>o.jsx(f,{}),play:async({canvasElement:a})=>{const n=await x(a).findByText("ルーム作成モーダルを開く");await v.click(n),await new Promise(u=>setTimeout(u,500));const t=await m.findByText("キャンセル");await l(t).toBeInTheDocument();const d=await m.findByText("新しいルームを作成");await l(d).toBeInTheDocument()}};e.parameters={...e.parameters,docs:{...(r=e.parameters)===null||r===void 0?void 0:r.docs,source:{originalSource:`{
