import{j as o,a as w}from"./iframe-DksO-9Vx.js";import{C as p,u as B}from"./index-b4n-NHrI.js";import{V as T}from"./v-stack-DYmAJw2q.js";import"./preload-helper-Dp1pzeXC.js";import"./zod-CnBHNqTB.js";import"./index-CTA6SVU8.js";import"./factory-B9CM4fuy.js";import"./responsive-modal-Kkae7Pv9.js";import"./index-DI793nQI.js";import"./create-slot-recipe-context-BUmgCShw.js";import"./render-strategy-B8g2ymyE.js";import"./use-breakpoint-D9vMxut-.js";import"./index-aq_vkBSD.js";var r,s,i;const{expect:l,screen:m,userEvent:v,within:x}=__STORYBOOK_MODULE_TEST__,P={title:"features/top/CreateRoomModal",component:p,parameters:{layout:"centered"}},f=()=>{const{openModal:a,modalProps:c}=B(),n=async t=>{console.log("ルーム作成:",t),alert(`ルーム "${t}" を作成しました！`)};return o.jsxs(T,{gap:4,children:[o.jsx(w,{onClick:a,colorPalette:"blue",size:"lg",children:"ルーム作成モーダルを開く"}),o.jsx(p,{...c,onCreateRoom:n})]})},e={render:()=>o.jsx(f,{}),play:async({canvasElement:a})=>{const n=await x(a).findByText("ルーム作成モーダルを開く");await v.click(n),await new Promise(u=>setTimeout(u,500));const t=await m.findByText("キャンセル");await l(t).toBeInTheDocument();const d=await m.findByText("新しいルームを作成");await l(d).toBeInTheDocument()}};e.parameters={...e.parameters,docs:{...(r=e.parameters)===null||r===void 0?void 0:r.docs,source:{originalSource:`{
