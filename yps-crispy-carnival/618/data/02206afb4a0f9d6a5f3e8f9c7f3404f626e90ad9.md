...
```
Error: Command failed: npx convex run --no-push testing:resetManagerScenarioData {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIskTmqiKgcyD2woIYvYJKQt3w"} --preview-name pr-618-e2e
