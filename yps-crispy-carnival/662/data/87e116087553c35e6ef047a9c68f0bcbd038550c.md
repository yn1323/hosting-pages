...
```
Error: Command failed: npx convex run --no-push testing:seedSubmitTestData {"submissionPattern":{"kind":"dateOnly"},"shopClosedDates":["2037-04-08"]} --preview-name pr-662-e2e
