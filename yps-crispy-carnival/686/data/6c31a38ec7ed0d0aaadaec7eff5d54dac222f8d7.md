...
```
Error: Command failed: npx convex run --no-push testing:resetManagerScenarioData {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIskTmqiKgcyD2woIYvYJKQt3w"} --preview-name pr-686-e2e
✖ Failed to run function "testing:resetManagerScenarioData":
Error: [Request ID: 194431a39d455506] Server Error
