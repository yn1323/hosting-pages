...
```
Error: Command failed: npx convex run --no-push testing:seedLegalStaffSubmitScenario {"legalConsentState":"missing"} --preview-name pr-686-e2e
✖ Failed to run function "testing:seedLegalStaffSubmitScenario":
Error: [Request ID: a94e218d68cee4ea] Server Error
