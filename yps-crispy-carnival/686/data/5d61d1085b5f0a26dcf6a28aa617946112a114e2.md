...
```
Error: Command failed: npx convex run --no-push testing:seedLineLinkScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIskTmqiKgcyD2woIYvYJKQt3w","managerEmail":"e2e-user-1@test.com"} --preview-name pr-686-e2e
✖ Failed to run function "testing:seedLineLinkScenario":
Error: [Request ID: ef1381f22cd361b8] Server Error
