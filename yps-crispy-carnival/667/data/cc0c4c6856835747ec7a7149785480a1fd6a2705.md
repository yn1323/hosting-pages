...
```
Error: Command failed: npx convex run --no-push testing:resetManagerScenarioData {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsoSy63HHFRRNA9Q90QBMZQw3"} --preview-name pr-667-e2e
