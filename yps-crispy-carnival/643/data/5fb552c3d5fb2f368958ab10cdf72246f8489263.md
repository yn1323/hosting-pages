...
```
Error: Command failed: npx convex run --no-push testing:seedStaffRegistrationReviewScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsmWzFysslv4L6B4dU2P3Hkiq","managerEmail":"e2e-user-2@test.com","shopName":"スタッフ参加承認E2E店舗"} --preview-name pr-643-e2e
