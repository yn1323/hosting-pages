...
```
Error: Command failed: npx convex run --no-push testing:seedLegalStaffSubmitScenario {"legalConsentState":"missing"} --preview-name pr-640-e2e
✖ Failed to run function "testing:seedLegalStaffSubmitScenario":
Error: [Request ID: c7e11eb62476f7e8] Server Error
