...
```
Error: Command failed: npx convex run --no-push testing:seedLegalManagerConsentScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsmWzFysslv4L6B4dU2P3Hkiq","managerEmail":"e2e-user-2@test.com","legalConsentState":"current"} --preview-name pr-640-e2e
✖ Failed to run function "testing:seedLegalManagerConsentScenario":
Error: [Request ID: e20fad0adfcc5e34] Server Error
