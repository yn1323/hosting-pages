...
```
Error: Command failed: npx convex run --no-push testing:seedStaffRegistrationReviewScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIskTmqiKgcyD2woIYvYJKQt3w","managerEmail":"e2e-user-1@test.com","shopName":"スタッフ参加承認E2E店舗"} --preview-name pr-545-e2e
✖ Failed to run function "testing:seedStaffRegistrationReviewScenario":
Error: [Request ID: 94e7360b2330f6da] Server Error
