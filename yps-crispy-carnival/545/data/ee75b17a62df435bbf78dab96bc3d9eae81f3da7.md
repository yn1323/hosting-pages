...
- Name: scenarios/staff-shift-submission.test.ts >> スタッフのシフト希望提出 >> 未提出→提出→修正→再提出のハッピーパス
- Location: e2e/scenarios/staff-shift-submission.test.ts:17:3

# Error details

```
Error: Command failed: npx convex run --no-push testing:seedSubmitTestData --preview-name pr-545-e2e
✖ Failed to run function "testing:seedSubmitTestData":
Error: [Request ID: be7b11271f4a2322] Server Error
