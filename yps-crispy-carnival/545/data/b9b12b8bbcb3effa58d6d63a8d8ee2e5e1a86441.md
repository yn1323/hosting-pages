...
```
Error: Command failed: npx convex run --no-push testing:resetManagerScenarioData {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsmWzFysslv4L6B4dU2P3Hkiq"} --preview-name pr-545-e2e
✖ Failed to run function "testing:resetManagerScenarioData":
Error: [Request ID: 3658ab0251abb0be] Server Error
