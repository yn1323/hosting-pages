...
```
Error: Command failed: npx convex run --no-push testing:seedStaffRegistrationReviewScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsoSy63HHFRRNA9Q90QBMZQw3","managerEmail":"e2e-user-3@test.com","shopName":"スタッフ登録済み重複E2E店舗","existingStaff":{"name":"登録済みスタッフ","email":"existing-registration-e2e@example.com"}} --preview-name pr-545-e2e
✖ Failed to run function "testing:seedStaffRegistrationReviewScenario":
Error: [Request ID: 3281bf1f63a528a0] Server Error
Could not find function for 'testing:seedStaffRegistrationReviewScenario'. Did you forget to run `npx convex dev`?
