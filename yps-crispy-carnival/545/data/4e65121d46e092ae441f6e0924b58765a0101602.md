...
```
Error: Command failed: npx convex run --no-push testing:seedLegalStaffSubmitScenario {"legalConsentState":"missing"} --preview-name pr-545-e2e
✖ Failed to run function "testing:seedLegalStaffSubmitScenario":
Error: [Request ID: 30d6e3550ce632d6] Server Error
