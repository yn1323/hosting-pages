...
```
Error: Command failed: npx convex run --no-push testing:seedSubmitTestData {"submissionPattern":{"kind":"dateOnly"},"shopClosedDates":["2037-04-08"]} --preview-name pr-545-e2e
✖ Failed to run function "testing:seedSubmitTestData":
Error: [Request ID: c2c14d2475af8276] Server Error
