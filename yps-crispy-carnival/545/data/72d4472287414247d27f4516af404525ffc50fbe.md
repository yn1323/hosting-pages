...
```
Error: Command failed: npx convex run --no-push testing:seedLineLinkScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsoSy63HHFRRNA9Q90QBMZQw3","managerEmail":"e2e-user-3@test.com"} --preview-name pr-545-e2e
✖ Failed to run function "testing:seedLineLinkScenario":
Error: [Request ID: 6bdb1cc5fac08b13] Server Error
