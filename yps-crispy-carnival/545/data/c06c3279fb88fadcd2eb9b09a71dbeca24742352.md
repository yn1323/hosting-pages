...
```
Error: Command failed: npx convex run --no-push testing:seedLineLinkScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsmWzFysslv4L6B4dU2P3Hkiq","managerEmail":"e2e-user-2@test.com"} --preview-name pr-545-e2e
✖ Failed to run function "testing:seedLineLinkScenario":
Error: [Request ID: 4251fca46e5df9b3] Server Error
