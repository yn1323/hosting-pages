...
```
Error: Command failed: npx convex run --no-push testing:seedSubmitTestData {"deadlinePassed":true} --preview-name pr-545-e2e
✖ Failed to run function "testing:seedSubmitTestData":
Error: [Request ID: 79c773b043077140] Server Error
Could not find function for 'testing:seedSubmitTestData'. Did you forget to run `npx convex dev`?
