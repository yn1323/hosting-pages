...
```
Error: Command failed: npx convex run --no-push testing:resetManagerScenarioData {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIskTmqiKgcyD2woIYvYJKQt3w"} --preview-name pr-545-e2e
✖ Failed to run function "testing:resetManagerScenarioData":
Error: [Request ID: 90a1812f19edb59d] Server Error
