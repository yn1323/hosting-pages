...
```
Error: Command failed: npx convex run --no-push testing:seedLegalManagerConsentScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsoSy63HHFRRNA9Q90QBMZQw3","managerEmail":"e2e-user-3@test.com","legalConsentState":"current"} --preview-name pr-545-e2e
✖ Failed to run function "testing:seedLegalManagerConsentScenario":
Error: [Request ID: 1275f8e94827b385] Server Error
