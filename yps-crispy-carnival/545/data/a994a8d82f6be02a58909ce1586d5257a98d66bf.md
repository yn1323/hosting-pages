...
```
Error: Command failed: npx convex run --no-push testing:createLineLinkTokenForStaff {"staffEmail":"tanaka@example.com","shopId":"nh77vt93f39p3nmgwqe4qm0s2s88yzrd"} --preview-name pr-545-e2e
✖ Failed to run function "testing:createLineLinkTokenForStaff":
Error: [Request ID: e938976b7a5bf81a] Server Error
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e23]:
      - generic [ref=e25]:
        ...
        - generic [ref=e27]:
          - heading "スタッフ登録済み重複E2E店舗" [level=1] [ref=e29]
