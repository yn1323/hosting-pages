...
```
Error: Command failed: npx convex run --no-push testing:seedStaffRegistrationReviewScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIskTmqiKgcyD2woIYvYJKQt3w","managerEmail":"e2e-user-1@test.com","shopName":"スタッフ招待登録済み重複E2E店舗","existingStaff":{"name":"登録済みスタッフ","email":"existing-registration-e2e@example.com"}} --preview-name pr-657-e2e
✖ Error fetching POST  https://api.convex.dev/api/deployment/authorize_preview 404 Not Found: PreviewNotFound: Preview deployment pr-657-e2e not found: https://api.convex.dev/api/deployment/authorize_preview
