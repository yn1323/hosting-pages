...
```
Error: Command failed: npx convex run --no-push testing:seedOpenRecruitmentNotificationScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsoSy63HHFRRNA9Q90QBMZQw3","managerEmail":"e2e-user-3@test.com","dates":{"periodStart":"2026-07-13","periodEnd":"2026-07-19","deadline":"2026-07-12","dates":["2026-07-13","2026-07-14","2026-07-15","2026-07-16","2026-07-17","2026-07-18","2026-07-19"]}} --preview-name pr-663-e2e
✖ Error fetching POST  https://api.convex.dev/api/deployment/authorize_preview 404 Not Found: PreviewNotFound: Preview deployment pr-663-e2e not found: https://api.convex.dev/api/deployment/authorize_preview
