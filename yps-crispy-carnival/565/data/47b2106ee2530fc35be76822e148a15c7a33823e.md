...
```
Error: Command failed: npx convex run --no-push testing:seedLegalManagerConsentScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIskTmqiKgcyD2woIYvYJKQt3w","managerEmail":"e2e-user-1@test.com","legalConsentState":"current"} --preview-name pr-565-e2e
✖ Failed to run function "testing:seedLegalManagerConsentScenario":
Error: [Request ID: ac82be4b1c610edd] Server Error
