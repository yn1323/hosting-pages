...
```
Error: Command failed: npx convex run --no-push testing:getLatestMagicLinkToken {"shopId":"nn73pmq5p434tczbmgttwjde7x892bfb","staffEmail":"tanaka@example.com","purpose":"submit"} --preview-name pr-565-e2e
✖ Failed to run function "testing:getLatestMagicLinkToken":
Error: [Request ID: efa8f5cc291b86b0] Server Error
