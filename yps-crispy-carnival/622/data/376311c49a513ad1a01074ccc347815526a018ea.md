...
```
Error: Command failed: npx convex run --no-push testing:getLatestMagicLinkToken {"shopId":"nn7en820db7agfd0b6ppydjc8189s9bk","staffEmail":"tanaka@example.com","purpose":"submit"} --preview-name pr-622-e2e
✖ Error fetching POST  https://api.convex.dev/api/deployment/authorize_preview 404 Not Found: PreviewNotFound: Preview deployment pr-622-e2e not found: https://api.convex.dev/api/deployment/authorize_preview
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e25]:
      - generic [ref=e27]:
        ...
        - generic [ref=e29]:
          - heading "法務同意テスト店舗" [level=1] [ref=e31]
