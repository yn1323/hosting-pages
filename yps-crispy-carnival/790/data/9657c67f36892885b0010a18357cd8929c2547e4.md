...
Call log:
  - waiting for getByRole('radio', { name: '管理者候補スタッフを選択', exact: true })
    - locator resolved to <input type="radio" name="_r_8_" data-ownedby="radio-group:_r_8_" value="pn7c9gwt5ex511g7rrn8yyvj8s8cdbqa" id="radio-group:_r_8_:radio:input:pn7c9gwt5ex511g7rrn8yyvj8s8cdbqa" aria-labelledby="radio-group:_r_8_:radio:label:pn7c9gwt5ex511g7rrn8yyvj8s8cdbqa"/>
