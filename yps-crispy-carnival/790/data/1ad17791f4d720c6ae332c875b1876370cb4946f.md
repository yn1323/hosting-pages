...
Call log:
  - waiting for getByRole('radio', { name: '管理者受諾スタッフを選択', exact: true })
    - locator resolved to <input type="radio" name="_r_9_" data-ownedby="radio-group:_r_9_" value="pn775qzxf2ganfhrsqcrw8rhjs8cc7fz" id="radio-group:_r_9_:radio:input:pn775qzxf2ganfhrsqcrw8rhjs8cc7fz" aria-labelledby="radio-group:_r_9_:radio:label:pn775qzxf2ganfhrsqcrw8rhjs8cc7fz"/>
