...
Call log:
  - waiting for getByRole('radio', { name: '管理者受諾スタッフを選択', exact: true })
    - locator resolved to <input type="radio" name="_r_7_" data-ownedby="radio-group:_r_7_" value="pn7dt30rjmvdk7m0esdgrd2p758ccz5p" id="radio-group:_r_7_:radio:input:pn7dt30rjmvdk7m0esdgrd2p758ccz5p" aria-labelledby="radio-group:_r_7_:radio:label:pn7dt30rjmvdk7m0esdgrd2p758ccz5p"/>
