...
```
Error: Command failed: npx convex run --no-push testing:seedLegalStaffConsentPageScenario {"legalConsentState":"missing"} --preview-name pr-564-e2e
✖ Failed to run function "testing:seedLegalStaffConsentPageScenario":
Error: [Request ID: cda03a5a80e911c4] Server Error
