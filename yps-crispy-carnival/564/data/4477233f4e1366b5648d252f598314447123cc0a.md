      ...
      - region "スタッフ一覧" [ref=e89]:
        - generic [ref=e90]:
          ...
          - button "スタッフを招待" [ref=e101] [cursor=pointer]:
            - img [ref=e102]
            - text: スタッフを招待
        - paragraph [ref=e103]: 募集作成・シフト確定時にスタッフへ通知します。届かない場合はスタッフ右のメニューから再送できます。
        - generic [ref=e105]:
