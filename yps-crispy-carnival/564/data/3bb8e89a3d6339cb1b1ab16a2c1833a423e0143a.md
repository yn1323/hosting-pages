...
```
Error: Command failed: npx convex run --no-push testing:resetManagerScenarioData {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIskTmqiKgcyD2woIYvYJKQt3w"} --preview-name pr-564-e2e
✖ Failed to run function "testing:resetManagerScenarioData":
Error: [Request ID: 8355b62f8949ac27] Server Error
