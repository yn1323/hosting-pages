...
```
Error: Command failed: npx convex run --no-push testing:seedOpenRecruitmentNotificationScenario {"managerAuthTokenIdentifier":"https://comic-drum-38.clerk.accounts.dev|user_3CIsoSy63HHFRRNA9Q90QBMZQw3","managerEmail":"e2e-user-3@test.com","dates":{"periodStart":"2026-07-06","periodEnd":"2026-07-12","deadline":"2026-07-05","dates":["2026-07-06","2026-07-07","2026-07-08","2026-07-09","2026-07-10","2026-07-11","2026-07-12"]}} --preview-name pr-620-e2e
✖ Error fetching POST  https://api.convex.dev/api/deployment/authorize_preview 404 Not Found: PreviewNotFound: Preview deployment pr-620-e2e not found: https://api.convex.dev/api/deployment/authorize_preview
